...
{
	row.insertCell(index).innerHTML = getTimeStringCurrentTime()
...
function kit_makeRow(obj,row)
{
	...
	row.insertCell(2).innerHTML = obj.kitName
}
...
function chat_makeRow(obj, row)
{
	...
	row.insertCell(1).innerHTML = channelName
	
	row.insertCell(2).innerHTML = obj.speaker +":"
	addPlayerSelectFunctionToCell(row.cells[2],obj.speaker,obj.playerID)
	
	row.insertCell(3).innerHTML = obj.text //TODO make sure this input cant inject scripts or something idonnu
